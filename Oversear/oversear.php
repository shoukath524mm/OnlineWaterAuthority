<?php
  ...
  {
    header('location:Oversear/oversearhome.php');
  }
  ?>
<!DOCTYPE html>
...
<form action="oversearlogin.php" method="post" novalidate>
<fieldset class="form-group position-relative has-icon-left mb-1">
<input type="text" class="form-control form-control-lg input-lg"  name="o_id" id="user-name" placeholder="Enter Employee ID" required>
<div class="form-control-position">
<i class="icon-head"></i>
</div>
</fieldset>
<fieldset class="form-group position-relative has-icon-left">
<input type="password" class="form-control form-control-lg input-lg" id="user-password" name="phone" placeholder="Enter Mobile Number" required>
<div class="form-control-position">
<i class="icon-key3"></i>
</div>
</fieldset>
...
<button type="submit" class="btn btn-info btn-lg btn-block ae_login"><i class="icon-unlock2"></i> Login</button>
</form>
<?php 
