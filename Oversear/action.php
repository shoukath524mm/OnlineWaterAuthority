...
session_start();
    ...
    $result=$conn->query("SELECT * FROM complaint_tb WHERE id='$id'");
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="actionpage.php?task=update&id=<?php echo$id;?>" method="post">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control"  name="status" value="1" >
												...
												<i class="icon-check2"></i> Solve</button>
												</div>
												</div>
											</div>
										</div>
