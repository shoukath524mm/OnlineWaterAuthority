...
session_start();
    ...
    $sql="SELECT * FROM oversear_tb where id='".$_SESSION['id']."'";
	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Customer</h2>
			</div>
                                               ...
                                               if ($result->num_rows>0)
                                                       {
														echo"<tr role='row'>
																...
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Address</th>
																...
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Approved Date</th>
