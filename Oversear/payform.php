...
session_start();
    ...
    $result=$conn->query("SELECT * FROM bill_tb WHERE id='$id'");
    ...
    <?php
     ...
     if (isset($_GET["task"])) 
     {
     	if ($_GET["task"]=="update") 
     	{
            $id=@$_GET['id'];
            $z= date('d/m/y');	
            $update=$conn->query("UPDATE bill_tb SET status='1',p_date='$z'  where id=$id")or die(mysqli_error());
            if($update>0)
            {
            	header("location:paybill.php?task=Successful");
            }
            else
            {
            	header("location:payform.php?task=failed");
            }
     	}
     }
			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="assets/images/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">Oversear</span></a>
						<div class="dropdown-menu dropdown-menu-right">
						<a href="oversearlogout.php" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
				...
				<li class=" nav-item"><a href="oversearhome.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>


				<li class=" nav-item"><a href="addbill.php"><i class="icon-equalizer"></i><span data-i18n="nav.components.main" class="menu-title">Add Bill</span></a></li>

				<li class=" nav-item"><a href="viewcustomer.php"><i class="icon-book"></i><span data-i18n="nav.icons.main" class="menu-title">View Consumers</span></a>
				</li>

				<li class=" nav-item"><a href="paybill.php"><i class="icon-cash"></i><span data-i18n="nav.icons.main" class="menu-title">Bill Payment</span></a>
				</li>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="payform.php?task=update&id=<?php echo $id;?>" method="post">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Name</label>
													<input type="text" id="" class="form-control"  name="name" autocomplete="off" value="<?php echo $a;?>">
													</div>
												</div>	
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Mobile</label>
													<input type="text" id="" class="form-control"  name="mobile" autocomplete="off" value="<?php echo $b; ?>">
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" name="aadhar" autocomplete="off" value="<?php echo $d;?>">
													</div>
												</div>
												
												
													<input type="hidden" id="" class="form-control"  name="status" value="1">
												
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Consumer Number</label>
													<input type="text" id="" class="form-control" placeholder="Enter Consumer Number" name="c_number" autocomplete="off" value="<?php echo $e?>" >
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Enter House Number" name="h_no" autocomplete="off" value="<?php echo $g;?>">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group ">
													<label for="">Date</label>
													<input type="text" id="" class="form-control" name="dat" autocomplete="off" value="<?php echo $f;?>">
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control"  name="amount" autocomplete="off" value="<?php echo $h;?>" >
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group sandbox-container">
													<label for="">Last Date Of Payment</label>
													<input type="text" id="" class="form-control"  name="l_date" autocomplete="off" value="<?php echo $i;?>">
													<input type="hidden" id="" class="form-control"  name="status">
													<input type="hidden" id="" class="form-control"  name="p_date" value="">
													</div>
												</div>
												...
												<i class="icon-fa fa-cc-visa"></i> Pay</button>
												</div>
												</div>
											</div>
										</div>
