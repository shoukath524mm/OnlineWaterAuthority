...
session_start();
    ...
    $result=$conn->query("SELECT * FROM approval_tb WHERE id='$id'");
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="insertbill.php" method="post">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" name="address" autocomplete="off" value="<?php echo $c;?>">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" name="dat" autocomplete="off" value="<?php echo date('d-m-y');?>">
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Bill Amount" name="amount" autocomplete="off" >
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group sandbox-container">
													<label for="">Last Date Of Payment</label>
													<input type="text" id="" class="form-control" placeholder="dd-mm-yyyy" name="l_date" autocomplete="off">
													</div>
												</div>
												...
												<i class="icon-check2"></i> Approve</button>
												</div>
												</div>
											</div>
										</div>
