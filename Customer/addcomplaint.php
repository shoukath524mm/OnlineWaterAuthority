						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="insertcomplaint.php" method="post">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="dd-mm-yyyy" name="dat" autocomplete="off">
													</div>
												</div>	
												...
												<div class="col-md-12">
													...
													<textarea id="" rows="1" class="form-control summernote hidden" name="complaint" placeholder="Enter your complaint"></textarea>
													</div>
												</div>	
