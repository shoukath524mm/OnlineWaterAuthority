			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="assets/images/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name"><?php echo $e;?></span></a>
						<div class="dropdown-menu dropdown-menu-right">
						<a href="customerlogout.php" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
...
<!-- main menu-->
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			...
			<li class=" nav-item"><a href="customerhome.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>


				<li class=" nav-item"><a href="addcomplaint.php"><i class="icon-equalizer"></i><span data-i18n="nav.components.main" class="menu-title">Add Complaint</span></a></li>

				<li class=" nav-item"><a href="viewbill.php"><i class="icon-sphere"></i><span data-i18n="nav.icons.main" class="menu-title">View Bill</span></a>
				</li>

				<li class=" nav-item"><a href="paidbill.php"><i class="icon-book"></i><span data-i18n="nav.icons.main" class="menu-title">Paid Bill</span></a>
				</li>
				<li class=" nav-item"><a href="viewcomplaint.php"><i class="icon-eye"></i><span data-i18n="nav.icons.main" class="menu-title">View Complaints</span></a>
				</li>
							...
							<div class="card-body collapse in">
								<div class="card-block card-dashboard">
									...
									<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100% ;">
                                                    ...
                                                    <?php
                                                    include("dbconnection.php");
                                                    $sql="SELECT * FROM bill_tb where status='0' and mobile='".$_SESSION['mobile']."'";
                                                    $result= $conn->query($sql);
                                               if ($result->num_rows>0)
                                                       {
														echo"<tr role='row'>
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Consumer Name</th>

																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Consumer Number</th>
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>House Number</th>															
																

																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Mobile</th>

																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Aadhar</th>
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Bill Date</th>

																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Bill Amount</th>

																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Last Date</th>
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Print</th>
...
while($row=$result->fetch_assoc())
{
															echo"<tr role='row' class='odd'>
																...
																<td class='sorting_1'>".$row['c_number']."</td>
																	
																<td class='sorting_1'>".$row['h_no']."</td>
																<td class='sorting_1'>".$row['mobile']."</td>
																<td class='sorting_1'>".$row['aadhar']."</td>
																<td class='sorting_1'>".$row['dat']."</td>														
																<td class='sorting_1'>".$row['amount']."</td>
																<td class='sorting_1'>".$row['l_date']."</td>
																<td>
																
																<a class='btn btn-info' href='printbill.php?id=".$row['id']."'>
