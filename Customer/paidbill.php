							...
							<div class="card-body collapse in">
								<div class="card-block card-dashboard">
									...
									<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100% ;">
                                                    ...
                                                    <?php
                                                    include("dbconnection.php");
                                                    $sql="SELECT * FROM bill_tb where status='1' and mobile='".$_SESSION['mobile']."'";
                                                    $result= $conn->query($sql);
                                               if ($result->num_rows>0)
                                                       {
														echo"<tr role='row'>
																...
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Paid Amount</th>

																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Paid Date</th>
...
while($row=$result->fetch_assoc())
{
															echo"<tr role='row' class='odd'>
																...
																<td class='sorting_1'>".$row['p_date']."</td>
