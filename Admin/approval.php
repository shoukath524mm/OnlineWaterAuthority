...
session_start();
    ...
    $result=$conn->query("SELECT * FROM customer_tb WHERE id='$id'");
	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Approval Form</h2>
			</div>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="approvecode.php" method="post">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Consumer Number" name="c_number" autocomplete="off" >
													</div>
												</div>
												<div class="col-md-6">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Enter House Number" name="h_no" autocomplete="off" >
													</div>
												</div>
