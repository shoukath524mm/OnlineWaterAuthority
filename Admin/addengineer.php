	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
				...
				<li class=" nav-item"><a href="adminhome.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>


				<li class=" nav-item"><a href="addengineer.php"><i class="icon-equalizer"></i><span data-i18n="nav.components.main" class="menu-title">Add Engineer</span></a></li>

				<li class=" nav-item"><a href="addoversear.php"><i class="icon-sphere"></i><span data-i18n="nav.icons.main" class="menu-title">Add Oversear</span></a>
				</li>

				<li class=" nav-item"><a href="viewcustomer.php"><i class="icon-book"></i><span data-i18n="nav.icons.main" class="menu-title">View Consumer</span></a>
				</li>
	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Assistant Engineer</h2>
			</div>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="insertengg.php" name="contactForm" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Employee ID</label>
													<input type="text"  class="form-control" placeholder="Enter Employee id" name="e_id" autocomplete="off" required="yes">
													</div>
												</div>	
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Name</label>
													<input type="text" id="" class="form-control" placeholder="Enter Full Name" name="name" autocomplete="off" required="yes">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													...
													<input type="radio" name="gender" value="male" class="custom-control-input" required="yes">
													<span class="custom-control-indicator"></span>
													<span class="custom-control-description">Male</span>
													</label>
													<label class="display-inline-block custom-control custom-radio">
													<input type="radio" name="gender" value="female" class="custom-control-input" required="yes">
													<span class="custom-control-indicator"></span>
												...
												<div class="col-md-6">
													...
													<input type="mail" id="" class="form-control" placeholder="Enter E-mail address" name="mail" autocomplete="off" required="yes">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Phone Number</label>
													<input type="text" id="" class="form-control" placeholder="Enter Phone Number" name="phone" autocomplete="off" required="yes">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Photo</label>
													<input type="file" id="" class="form-control" placeholder="Upload Photo" name="photo" required="yes">
													</div>
												</div>		
												...
												<div class="col-md-12">
													...
													<textarea id="" rows="5" class="form-control summernote hidden" name="address" placeholder="Address" required="yes"></textarea>
													</div>
												</div>
												<div class="col-md-12">
												<div class="form-group">
                                               ...
                                               if ($result->num_rows>0)
                                                       {
														...
														while($row=$result->fetch_assoc()){
															...
															echo "<tr role='row' class='odd'>
																...
																<td>".$row['phone']."</td>
																<td><img src=".'uploads/'.$row['photo']." width='100' height='100'</td>
																
																<td>															
																<a href='deleteengg.php?id=".$row['id']."' onclick='return confirm('Are you sure want to delete this post?')'><span style='color:#fff;' class='btn btn-danger glyphicon glyphicon-trash' title='Delete post'></span></a> 
																</td>
															</tr>";
															}
														}
