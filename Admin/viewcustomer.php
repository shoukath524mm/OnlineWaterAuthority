	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Consumer Request</h2>
			</div>
							...
							<div class="card-body collapse in">
								<div class="card-block card-dashboard">
									...
									<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100% ;">
                                                    ...
                                                    $sql="SELECT * FROM customer_tb where status='0'";
                                               ...
                                               if ($result->num_rows>0)
                                                       {
														echo"<tr role='row'>
																...
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Action</th>
...
while($row=$result->fetch_assoc())
{
															...
															<a class='btn btn-info' href='approval.php?id=".$row['id']."'>
