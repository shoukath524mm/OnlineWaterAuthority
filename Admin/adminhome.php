...
session_start();
    ...
    width: 100%;
    float: left;
background: linear-gradient(90deg, rgba(32,69,111,1) 0%, rgba(31,115,201,1) 63%, rgba(0,104,255,1) 100%);
...
.block_head_2{
    ...
    $sql="SELECT COUNT(*) FROM engg_tb";
    $result=$conn->query($sql);

    ?>
      <?php 
    include("dbconnection.php");
    $sql="SELECT COUNT(*) FROM oversear_tb";
    $result1=$conn->query($sql);

    ?>
    <?php 
    include("dbconnection.php");
    $sql="SELECT COUNT(*) FROM approval_tb";
											...
											<div class="col-lg-4 col-md-6 col-sm-6">
												<div class="home-block">
													...
													<div class="content_center">
														...
														<h5 class="block_head_2">Engineers</h5>
														
														<h6 class="block_head_2"><?php echo $a;?></h6>
											...
											<div class="col-lg-4 col-md-6 col-sm-6">
												<div class="home-block">
													...
													<div class="content_center">
														...
														<h5 class="block_head_2">Oversears</h5>
														
														<h6 class="block_head_2"><?php echo $b;?></h6>
											...
											<div class="col-lg-4 col-md-6 col-sm-6">
												<div class="home-block">
													...
													<div class="content_center">
														...
														<h5 class="block_head_2">Consumers</h5>
														
														<h6 class="block_head_2"><?php echo $c;?></h6>
