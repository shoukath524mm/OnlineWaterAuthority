	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h1  class="content-header-title">Oversear</h1>
			</div>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="insertoversear.php" method="post" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Oversear ID</label>
													<input type="text" id="" class="form-control" placeholder="Enter Employee id" name="o_id" autocomplete="off" required="yes">
													</div>
												</div>	
												<div class="col-md-6">
													<div class="form-group">
                                               ...
                                               if ($result->num_rows>0)
                                                       {
														...
														while($row=$result->fetch_assoc()){
															...
															echo "<tr role='row' class='odd'>
																...
																<a href='deleteoversear.php?id=".$row['id']."' onclick='return confirm('Are you sure want to delete this post?')'><span style='color:#fff;' class='btn btn-danger glyphicon glyphicon-trash' title='Delete post'></span></a> 
																</td>
															</tr>";
															}
														}
