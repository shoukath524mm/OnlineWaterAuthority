<?php
  ...
  {
    header('location:Engineer/engghome.php');
  }
  ?>
<!DOCTYPE html>
...
<form action="engglogin.php" method="post" novalidate>
<fieldset class="form-group position-relative has-icon-left mb-1">
<input type="text" class="form-control form-control-lg input-lg"  name="e_id" id="user-name" placeholder="Enter Employee ID" required>
